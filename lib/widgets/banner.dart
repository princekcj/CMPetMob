...
class _AnimalBannerPageState extends State<AnimalBannerPage> {
  ...
  Future<void> _initializeAnimalsWithZero() async {
    try {
      ...
      if (beardedDragonValues.contains("0")) {
        animalsList.add({
          'color': ImageConstant.redpaw,
